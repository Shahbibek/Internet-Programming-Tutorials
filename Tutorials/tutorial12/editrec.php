...
$sql = "SELECT * FROM tbl_machine where id=".$_SESSION['id'];
        ...
        <div class="col-md-7 col-md-5 offset-xl-1">
            <form action="updaterec.php" method="POST">
                ...
                <div class="form-outline mb-3">
                    ...
                    <input type="text" id="form1Example13" value="<?php echo $row['machine_name']?>" name="name" class="form-control form-control-m" placeholder="Enter machine_name" />
                </div>

                <!-- Password input -->
                <div class="form-outline mb-3">
                    <label class="form-label" for="form1Example23">Description</label>
                    <input type="text" name="desc" value="<?php echo $row['description']?>" id="form1Example23" class="form-control form-control-m" placeholder="Enter Description" />
                </div>
